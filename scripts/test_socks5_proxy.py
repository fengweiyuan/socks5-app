    ...
    def test_socks5_handshake(self):
        ...
        try:
            ...
            if method == 2:  # USER_PASS_AUTH
                ...
                sock.close()
                return True, "SOCKS5握手成功 (用户名密码认证)"
            
            sock.close()
            return True, "SOCKS5握手成功 (无认证)"
...
def main():
    parser = argparse.ArgumentParser(description='SOCKS5代理功能测试工具')
    ...
    tester = Socks5Tester(args.host, args.port, args.timeout)
